...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--input_dir",
        type=str,
        default='/data/zll/yanghan/data/audio/AISHELL3/test/',
        # required=True,
    ...
    parser.add_argument(
        "--output_dir",
        type=str,
        default='/data/zll/yanghan/data/audio/AISHELL3/test_train/',
        # required=False,
    ...
    parser.add_argument(
        "--n_jobs", type=int, default=24, help="Number of threads to use, by default it uses all cores"
    )
