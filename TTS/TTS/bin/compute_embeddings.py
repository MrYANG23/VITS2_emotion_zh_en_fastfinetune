...
parser.add_argument("model_path", type=str, help="Path to model checkpoint file.",default='/data/zll/yanghan/TTS-main/model_dir/model_file.pth.tar')
parser.add_argument(
    "config_path",
    type=str,
    help="Path to model config file.",
    default='/data/zll/yanghan/TTS-main/model_dir/config_se.json'
)
...
parser.add_argument("output_path", type=str, help="path for output speakers.json and/or speakers.npy.",default='/data/zll/yanghan/TTS-main/model_dir/baker')
parser.add_argument(
...
dataset_config = BaseDatasetConfig(
    name="baker", meta_file_train="", language="zh-cn", path='/data/zll/yanghan/data/audio/Coqui_TTS_DATA/BZNSYP/'
)
####################################add_dataset_config############################
